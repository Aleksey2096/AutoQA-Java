...
Написать метод, который позволяет пересыпать фрукты из текущей коробки в другую. Помним про
сортировку фруктов: нельзя яблоки высыпать в коробку с апельсинами. Соответственно, в текущей
...
public class App {
    public static void main(String[] args) {
        ...
        System.out.println(appleBox.getWeight());       // 3.0
        ...
        appleBox.pourIntoBox(newAppleBox);

        System.out.println(appleBox.getNumberOfFruits());       // 0
        System.out.println(newAppleBox.getNumberOfFruits());    // 3
    }
}
